      ...
      <div>
        <span
          className={`font-medium ${
            conta.pago ? "line-through text-gray-400" : ""
          }`}
        >
          {conta.descricao} - R$ {conta.valor.toFixed(2)}{" "}
          {conta.vencimento && `(Venc. ${conta.vencimento})`}
        </span>
      </div>
        ...
        >
          ...
          >
            <path
              ...
              strokeWidth={2}
              d="M15.232 5.232l3.536 3.536M9 13l6.586-6.586a2 2 0 112.828 2.828L11.828 15.828a4 4 0 01-1.414.828l-4.243 1.415a1 1 0 01-1.263-1.263l1.415-4.243a4 4 0 01.828-1.414z"
            />
          </svg>
        </button>
        <button
